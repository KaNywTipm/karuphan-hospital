...
export default function BorrowReturnReport() {
    ...
    const [filteredData, setFilteredData] = useState<BorrowReturn[]>(borrowReturnData);
    ...
    const handleExcelExport = () => {
        ...
        const headers = ['ลำดับ', 'ผู้ยืม', 'หน่วยงาน', 'เลขครุภัณฑ์', 'ชื่อครุภัณฑ์', 'หมวดหมู่', 'วันที่ยืม', 'เหตุผลการยืม', 'สถานะ', 'วันที่คืน'];
        ...
        link.setAttribute('download', `รายงานสรุปการยืมคืน_${new Date().toLocaleDateString('th-TH')}.csv`);
